...
KEY_TYPE_VERTEX_NORMAL = 5
KEY_TYPE_POLYGON_NORMAL = 6
KEY_TYPE_UV_COORDINATES = 7
KEY_TYPE_VERTEX_WEIGHT = 8
KEY_TYPE_CLUSTER = 9  # for points, edges or polygons by setting context parameter
KEY_TYPE_POLYGON_CORNER_INDEXE_AND_NORMAL = 10
KEY_TYPE_VERTEX_COLOR = 11
KEY_TYPE_HARD_SAMPLE = 12  # also for points and edges
KEY_TYPE_CREASE_SAMPLE = 13  # for points and edges
KEY_TYPE_DENSITY = 14  # for volume data
KEY_TYPE_VELOCITY = 15
KEY_TYPE_TEMPERATURE = 16
KEY_TYPE_COLOR = 17
